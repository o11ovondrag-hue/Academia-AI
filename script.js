...
// --- 2. ЗАПРОС К API GEMINI (РАБОЧАЯ МОДЕЛЬ GEMINI 1.5 FLASH) ---
  async function callGemini(promptText) {
    // Используем проверенную и доступную на Free Tier модель gemini-1.5-flash
